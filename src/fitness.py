...
Set max_slots to enforce a timeslot limit and penalize conflicts via hard_penalty.
"""
...
def evaluate_population(
    ...
    for individual in population:
        fitness, details = fitness_function(
            individual, conflict_matrix, exam_to_idx, students, max_slots, hard_penalty
        )
